...
- Lecture notes CME 200 ([Notes](<a href="{{ "/docs/MatrixComputationsAnswerstoEvennumberedQuestions.pdf" | relative_url }}">) )
- Solutions to even numbered questions ([Solutions](<a href="{{ "/docs/MatrixComputationsAnswerstoEvennumberedQuestions.pdf" | relative_url }}">) ) 
